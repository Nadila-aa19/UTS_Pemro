	...
	foreach($sharebuttonsoption as $soption){
		switch ($soption){
			...
			case "Instagram" :
				...
				<a class="resp-sharing-button__link" href="mailto:?subject=<?php echo urlencode($title) ?>&amp;body=<?php echo urlencode($url) ?>" target="_self" rel="noopener" aria-label="Share by Instagram">
